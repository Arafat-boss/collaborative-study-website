...
const ThemeToggle = ({ className = "", showLabel = false }) => {
  ...
  return (
    <button
      onClick={toggleTheme}
      type="button"
      className={`relative inline-flex items-center gap-2 p-2 rounded-[5px] transition-all duration-300 focus:outline-none ${
        isDark
          ? "bg-slate-800 text-amber-400 hover:bg-slate-700 hover:text-amber-300 border border-slate-700 shadow-sm"
