...
const Banner = () => {
  ...
  return (
    <section className="relative flex items-center justify-center overflow-hidden bg-transparent text-gray-900 dark:text-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] sm:w-[500px] lg:w-[650px] h-[300px] sm:h-[450px] bg-gradient-to-r from-fuchsia-500/20 dark:from-fuchsia-600/30 via-violet-500/15 dark:via-violet-600/25 to-cyan-400/15 dark:to-cyan-500/25 rounded-full filter blur-[100px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-4 sm:space-y-6">
        ...
        <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-1.5 rounded-full bg-violet-50 dark:bg-violet-500/15 border border-violet-200 dark:border-violet-400/30 text-violet-700 dark:text-violet-200 text-xs sm:text-sm font-semibold backdrop-blur-md shadow-sm">
        ...
        <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3.5 pt-6 sm:pt-8 border-t border-gray-200 dark:border-slate-800/80 max-w-3xl mx-auto">
