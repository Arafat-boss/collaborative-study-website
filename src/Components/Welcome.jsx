    ...
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="relative overflow-hidden rounded-[5px] bg-blue-600 text-white p-6 sm:p-10 shadow-sm">
        <div className="relative z-10 space-y-4 max-w-2xl">
          ...
          <div className="pt-2 flex flex-wrap gap-3">
            <Link
              to="/"
              className="px-5 py-2.5 rounded-[5px] bg-white text-blue-600 font-semibold text-xs sm:text-sm hover:bg-blue-50 shadow-sm transition-colors inline-flex items-center gap-2"
            >
      ...
      <div className="space-y-4">
        <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
          {role === "admin" ? (
            <LuShield className="text-blue-600 dark:text-blue-400" />
          ) : role === "tutor" ? (
            <LuGraduationCap className="text-blue-600 dark:text-blue-400" />
          ) : (
        ...
        {role === "student" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <Link
              ...
              className="p-6 rounded-[5px] bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-200 group flex flex-col justify-between space-y-4"
            >
              <div className="space-y-3">
                <div className="w-12 h-12 rounded-[5px] bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-900/50 flex items-center justify-center text-xl transition-colors">
                  <LuCalendar />
                </div>
