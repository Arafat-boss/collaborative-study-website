    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="flex-shrink-0 px-5 py-2.5 rounded-[5px] bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs sm:text-sm shadow-sm flex items-center gap-1.5"
        >
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3].map((n) => (
            <div key={n} className="bg-white dark:bg-slate-900 rounded-[5px] p-6 border border-gray-100 dark:border-slate-800 animate-pulse space-y-3">
              <div className="h-6 bg-gray-200 dark:bg-slate-800 rounded-[5px] w-3/4" />
              <div className="h-16 bg-gray-200 dark:bg-slate-800 rounded-[5px] w-full" />
            </div>
          ))}
        </div>
      ) : notes.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {notes.map((note) => (
            <div
              key={note._id}
              className="bg-white dark:bg-slate-900 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-200 p-6 flex flex-col justify-between space-y-4"
            >
              ...
              <div className="pt-4 border-t border-gray-100 dark:border-slate-800 flex items-center justify-between gap-2">
                ...
                >
                  <LuPencil className="text-blue-600 dark:text-blue-400" /> Edit Note
                </button>
                <button
        ...
        <div className="py-16 text-center text-gray-500 dark:text-slate-400 bg-white dark:bg-slate-900 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm space-y-3">
          ...
          <Link
            to="/dashboard/createNote"
            className="inline-flex items-center gap-2 px-6 py-2.5 rounded-[5px] bg-blue-600 text-white text-xs font-semibold shadow-sm hover:bg-blue-700"
          >
