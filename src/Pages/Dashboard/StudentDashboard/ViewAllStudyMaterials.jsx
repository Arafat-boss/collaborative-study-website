  ...
  return (
    <div className="space-y-6">
      ...
      {bookedSessions.length > 0 && (
        <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-colors">
          <div className="flex items-center gap-3 text-sm text-gray-700 dark:text-slate-300">
            <span className="w-9 h-9 rounded-[5px] bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 flex items-center justify-center font-bold text-sm">
              <LuBookOpen />
            </span>
            <div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <LuFilter className="text-blue-600 dark:text-blue-400 text-sm flex-shrink-0" />
            <select
              value={selectedSessionFilter}
              onChange={(e) => handleFilterChange(e.target.value)}
              className="w-full sm:w-64 px-3 py-2 rounded-[5px] border border-gray-200 dark:border-slate-700 text-xs font-semibold text-gray-700 dark:text-slate-200 bg-gray-50 dark:bg-slate-800 focus:outline-none focus:border-blue-500 transition-all"
            >
      ...
      {isLoading ? (
        ...
        <div className="py-16 px-6 text-center text-gray-500 dark:text-slate-400 bg-white dark:bg-slate-900 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm space-y-4 max-w-xl mx-auto transition-colors">
          <div className="w-16 h-16 rounded-[5px] bg-blue-50 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 flex items-center justify-center text-3xl mx-auto">
            <LuBookOpen />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredMaterials.map((item) => (
            <div
              ...
              className="bg-white dark:bg-slate-900 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col justify-between group"
            >
              <div>
                <div className="relative aspect-video w-full overflow-hidden bg-gray-100 dark:bg-slate-800 rounded-t-[5px]">
                  ...
                  <div className="absolute top-3 right-3">
                    <span className="px-2.5 py-1 rounded-[5px] text-[10px] font-semibold uppercase tracking-wider bg-blue-600 text-white shadow-sm flex items-center gap-1">
                ...
                <div className="p-5 space-y-2.5">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/50 px-2 py-0.5 rounded-[5px] border border-blue-100 dark:border-blue-900/50">
                  ...
                  <div className="space-y-1 text-xs text-gray-500 dark:text-slate-400 pt-1 border-t border-gray-100 dark:border-slate-800">
                    <p className="flex items-center gap-1.5 truncate">
                      <LuUser className="text-blue-600 dark:text-blue-400" />
              ...
              <div className="p-5 pt-0">
                {item.materialLink ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-full py-2.5 px-4 rounded-[5px] bg-blue-600 hover:bg-blue-700 text-white font-semibold text-xs flex items-center justify-center gap-1.5 shadow-sm transition-all"
                  >
                    <LuExternalLink />
                  ...
                  <button
                    disabled
                    className="w-full py-2.5 px-4 rounded-[5px] bg-gray-100 dark:bg-slate-800 text-gray-400 dark:text-slate-500 font-medium text-xs cursor-not-allowed"
                  >
                    No link provided
                  </button>
                )}
        ...
        <div className="py-16 px-6 text-center text-gray-500 dark:text-slate-400 bg-white dark:bg-slate-900 rounded-[5px] border border-gray-100 dark:border-slate-800 shadow-sm space-y-3 max-w-md mx-auto transition-colors">
