  ...
  return (
    <ul className="space-y-1.5 w-full">
      <li>
        ...
        >
          <IoCreateOutline className="text-xl flex-shrink-0 text-blue-600 dark:text-blue-400" />
      ...
      <li>
        <NavLink
          ...
          className={navItemClass}
        >
          <IoCloudUploadOutline className="text-xl flex-shrink-0 text-blue-600 dark:text-blue-400" />
